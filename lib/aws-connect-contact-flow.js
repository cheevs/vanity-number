  ...
  constructor(scope, id, props) {
    super(scope, id, {
      ...
      policy: AwsCustomResourcePolicy.fromStatements([
        ...
        //todo: would never do this in production; need to dig into the CloudTrail logs to check which api calls were failing
        new PolicyStatement({
          effect: Effect.ALLOW,
          actions: [
            "*"
      ...
      onCreate: {
        ...
        parameters: {
          FunctionArn: "arn:aws:lambda:us-east-1:686151311692:function:testcdk2",
